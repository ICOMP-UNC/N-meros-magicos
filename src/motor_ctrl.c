...
void MOTOR_CTRL_start_routine(void) { evt = EV_START_ROUTINE; }

void MOTOR_CTRL_stop(void) { evt = EV_STOP; }

void MOTOR_CTRL_open(void) { evt = EV_OPEN; }

void MOTOR_CTRL_close(void) { evt = EV_CLOSE; }
...
uint32_t MOTOR_CTRL_get_status(void) { return status; }

int32_t MOTOR_CTRL_get_abs_pos(void) { return current_absoulute_pos; }

MOTOR_states_t MOTOR_CTRL_get_fsm_state(void) { return current_state; }

MOTOR_states_t MOTOR_CTRL_get_step(void) { return step; }
